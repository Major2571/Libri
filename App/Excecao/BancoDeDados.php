...
final class BancoDeDados extends Exception{
	 ...
	 * @uses App\Util\Util::verificarTipoErroBancoDeDados() Verificando o tipo de erro do banco de dados
	...
	public function __construct(
		...
		$complemento = Util::verificarTipoErroBancoDeDados( $excecao->errorInfo[ 1 ] );
